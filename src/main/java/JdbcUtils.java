...
public class JdbcUtils {
    ...
    public static Connection connectToDataBase()  {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres","postgres","hvkk2011");
    ...
    public static void createTable(String tableName, String... columnName_dataType ){
        ...
        columnName_dataValue.deleteCharAt(columnName_dataValue.length()-1); // bunla virgulu sildik
